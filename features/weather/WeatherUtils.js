...
// Weather Utilities
// ============================================================================
// Shared utility functions for weather data processing and display.
// Handles weather code interpretation, wind direction, and icon mapping.
...
/**
 * Get full weather description from WMO weather code
 ...
 * @param {number} code - WMO weather interpretation code
 * @returns {string} Abbreviated weather description
 */
 ...
 * @param {number} code - WMO weather interpretation code
 * @returns {string} Unicode emoji representing weather condition
 */
